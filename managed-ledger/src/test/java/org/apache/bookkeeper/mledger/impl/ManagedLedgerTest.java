...
public class ManagedLedgerTest extends MockedBookKeeperTestCase {
    ...
    public void testLedgerPublishTime() throws Exception {
        ...
        for (int i = 0; i < 5; i++) {
            Object ctx = new Entry.PublishTimestampGetter() {
                @Override
        ...
        assertTrue(firstLedger.getMinPublishTimestamp() == publishTimestamps.get(0)
                && firstLedger.getMaxPublishTimestamp() == publishTimestamps.get(1));
        assertTrue(secondLedger.getMinPublishTimestamp() == publishTimestamps.get(2)
                && secondLedger.getMaxPublishTimestamp() == publishTimestamps.get(3));
        assertTrue(thirdLedger.getMinPublishTimestamp() == 0
                && thirdLedger.getMaxPublishTimestamp() == 0);
    }
}
