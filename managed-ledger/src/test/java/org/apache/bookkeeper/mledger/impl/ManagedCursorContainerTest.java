...
public class ManagedCursorContainerTest {
    ...
    private static class MockManagedCursor implements ManagedCursor {
        ...
        @Override
        public void asyncFindNewestMatching(FindPositionConstraint constraint, Predicate<Entry> condition, Position start, Position end, AsyncCallbacks.FindEntryCallback callback, Object ctx, boolean isFindFromLedger) {
